...
const experiences = [
  {
    ...
    bullets: [
      'Completed an intensive, structured MERN stack development curriculum',
      'Built multiple full-stack projects with real-world features and clean architecture',
      'Practiced responsive UI design, API integration, and authentication systems',
      'Worked with modern tooling: Tailwind CSS, Git, and deployment pipelines',
    ],
  ...
  },
  {
    ...
    bullets: [
      'Built portfolio websites, full-stack web apps, and UI component systems from scratch',
      'Implemented authentication (JWT / NextAuth), file uploads, and cloud integrations',
      'Focused on performance optimization, clean code, and modern developer experience',
      'Continuously shipping projects to learn real-world patterns and best practices',
    ],
    highlight: 'Shipping real products, learning every day',
  },
];
...
function ExpCard({ exp, isDark, index }) {
  ...
  const t = {
    ...
    statBorder:  'rgba(220,38,38,0.14)',
  ...
  return (
    ...
    >
      ...
      <div className="exp-card-header" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
          <motion.div
            ...
            style={{
              ...
              background: isDark ? 'rgba(220,38,38,0.1)' : 'rgba(220,38,38,0.07)',
              border: '1px solid rgba(220,38,38,0.22)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: '1.4rem',
              boxShadow: hovered ? '0 0 20px rgba(220,38,38,0.2)' : 'none',
          ...
          <div>
            <h3 style={{
              ...
              color: t.title, letterSpacing: '-0.02em', lineHeight: 1.3,
            }}>
              {exp.role}
            </h3>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4, flexWrap: 'wrap' }}>
              <span style={{ fontSize: '0.85rem', fontWeight: 700, color: t.company }}>
                {exp.company}
              </span>
              <span style={{ color: t.meta, fontSize: '0.75rem' }}>·</span>
              <span style={{ fontSize: '0.75rem', color: t.meta, fontWeight: 500 }}>
                {exp.type}
              </span>
            </div>
          </div>
        ...
        <div className="exp-card-meta" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 7 }}>
          <div style={{
            ...
            <span style={{ fontSize: '0.72rem', fontWeight: 600, color: t.meta }}>
              {exp.duration}
            </span>
          </div>
          ...
          <div style={{
            ...
            background: isOngoing ? 'rgba(220,38,38,0.1)' : 'rgba(100,116,139,0.1)',
            border: `1px solid ${isOngoing ? 'rgba(220,38,38,0.25)' : 'rgba(100,116,139,0.2)'}`,
          }}>
            <span style={{
              width: 5, height: 5, borderRadius: '50%',
              background: isOngoing ? '#ef4444' : '#64748b',
              display: 'inline-block',
              animation: isOngoing ? 'exp-blink 1.4s ease infinite' : 'none',
            }} />
            <span style={{
              fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.1em',
              textTransform: 'uppercase',
              color: isOngoing ? '#ef4444' : t.meta,
            }}>
              {exp.status}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
          {stats.map((s) => (
            <div key={s.label} style={{
              ...
              <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: 900, color: '#ef4444', letterSpacing: '-0.02em' }}>
                {s.value}
              </p>
              <p style={{ margin: '2px 0 0', fontSize: '0.6rem', fontWeight: 600, color: t.meta, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                {s.label}
              </p>
            </div>
          ))}
      ...
      <ul style={{ margin: '0 0 20px', padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10 }}>
        {exp.bullets.map((b, i) => (
          ...
          >
            ...
            <span style={{ fontSize: '0.88rem', lineHeight: 1.75, color: t.body }}>
              {b}
            </span>
          </motion.li>
        ))}
      ...
      <div style={{
        ...
        background: t.hlBg, border: `1px solid ${t.hlBorder}`,
      }}>
        <svg width="13" height="13" fill="none" stroke="#ef4444" strokeWidth="2.2" viewBox="0 0 24 24">
          <polyline points="20 6 9 17 4 12"/>
        </svg>
        <span style={{ fontSize: '0.76rem', fontWeight: 600, color: isDark ? '#fca5a5' : '#dc2626' }}>
          {exp.highlight}
        </span>
      </div>
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        .exp-title-accent {
          ...
          animation: shimmer-exp 3s linear infinite;
        }
        ...
        @media (max-width: 768px) {
          ...
          .exp-note { flex-direction: row; align-items: flex-start !important; }
        }
        
        @media (max-width: 480px) {
          .exp-title-accent { display: block; }
      ...
      <section
        ...
        style={{ background: t.sectionBg, padding: '96px 0' }}
      >
        <div className="exp-grid-bg" style={{ '--gl': t.gridLine }} />

        {/* Blobs */}
        <div style={{
          position:'absolute', top:'10%', left:'-80px', width:400, height:400, borderRadius:'50%',
          background:`radial-gradient(circle, ${isDark?'rgba(185,28,28,0.1)':'rgba(220,38,38,0.06)'} 0%, transparent 70%)`,
          filter:'blur(80px)', pointerEvents:'none', animation:'exp-pulse 7s ease-in-out infinite',
        }} />
        <div style={{
          position:'absolute', bottom:'15%', right:'-60px', width:300, height:300, borderRadius:'50%',
          background:`radial-gradient(circle, ${isDark?'rgba(220,38,38,0.07)':'rgba(220,38,38,0.04)'} 0%, transparent 70%)`,
          filter:'blur(60px)', pointerEvents:'none',
          animation:'exp-pulse 9s ease-in-out infinite', animationDelay:'3s',
        }} />
        ...
        <div className="exp-container" style={{ maxWidth: 900, margin: '0 auto', padding: '0 48px', position: 'relative', zIndex: 1 }}>
          ...
          >
            <div style={{
              ...
              <span style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.16em', color: '#ef4444', textTransform: 'uppercase' }}>
                Experience
              </span>
            </div>
            ...
            <h2 style={{
              ...
              margin: '0 0 14px', color: t.heading,
            }}>
              Work &{' '}
