...
export default function About() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo('.about-badge, .about-heading', {
        opacity: 0, y: 32,
      }, {
        opacity: 1, y: 0,
        duration: 0.9,
  ...
  const stats = [
    { num: 1,  suffix: '+', label: 'Year of Journey' },
    { num: 10, suffix: '+', label: 'Projects Built'   },
    { num: 8,  suffix: '+', label: 'Tech Mastered'    },
    { num: 100, suffix: '%', label: 'Self-Motivated'  },
  ];
  ...
  const paragraphs = [
    ...
    `I come from a Qawmi Madrasa background — at first, I wondered whether I'd be able to succeed in tech. But with dedication and curiosity, I realized I'm fully capable of growing in this field. Alhamdulillah, this journey has given me real confidence.`,
    `One of my strengths is that I learn new things quickly when I focus. I enjoy exploring topics deeply, understanding the logic behind every concept. Currently I'm focused on modern web development and building practical projects — growing every single day.`,
  ];
      ...
      <style suppressHydrationWarning>{`
        ...
        .img-scanline {
          ...
          background: linear-gradient(180deg,
            transparent 0%, rgba(220,38,38,0.04) 50%, transparent 100%);
          pointer-events: none;
        }
      ...
      >
        ...
        <div className="about-container" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 48px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginBottom: 64 }}>
            ...
            >
              About{' '}
              <span className="heading-accent">The Developer</span>
            </h2>
          </div>

          <div
            className="about-grid-layout"
            style={{ display: 'grid', gridTemplateColumns: '1fr 1.15fr', gap: 56, alignItems: 'start' }}
          >
            <div className="about-image-wrap">
              <div
                className="img-glow"
                style={{ background: `radial-gradient(circle, ${t.imgGlow} 0%, transparent 70%)` }}
              />
              <div
                className="img-container"
                style={{
                  border: `1px solid ${t.imgBorder}`,
                  boxShadow: `0 0 60px ${t.imgGlow}, 0 30px 60px rgba(0,0,0,0.4)`,
                }}
              >
                ...
                <Image
                  ...
                  style={{
                    ...
                    display: 'block',
                    filter: isDark
                      ? 'saturate(0.88) contrast(1.04) brightness(0.96)'
                ...
                <div
                  className="img-badge"
                  style={{
                    background: isDark ? 'rgba(10,10,14,0.85)' : 'rgba(255,255,255,0.88)',
                    border: `1px solid ${t.badgeBorder}`,
                  }}
                >
            ...
            <div className="about-text-block" style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <div>
                <p style={{ margin: '0 0 12px', fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: t.body }}>
                  Current Stack
                </p>
