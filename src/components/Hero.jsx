...
function CodeEditor({ isDark }) {
  const lines = [
    ...
    { num: '07', tokens: [{ t: 'key', v: ' available' }, { t: 'op', v: ': ' }, { t: 'bool', v: 'true' }, { t: 'op', v: ',' }] },
    { num: '08', tokens: [{ t: 'key', v: ' motto' }, { t: 'op', v: ': ' }, { t: 's2', v: '"Build with Purpose"' }] },
    { num: '09', tokens: [{ t: 'op', v: '};' }] },
    { num: '10', tokens: [] },
    { num: '11', tokens: [{ t: 'var', v: 'developer' }, { t: 'op', v: '.' }, { t: 'fn', v: 'showcase' }, { t: 'op', v: '();' }] },
  ];
...
export default function Hero() {
  ...
  const t = {
    ...
    scrollColor: isDark ? 'rgba(148,163,184,0.4)' : 'rgba(100,116,139,0.4)',
    scrollBorder: isDark ? 'rgba(255,255,255,0.12)' : 'rgba(0,0,0,0.12)',
  };
  ...
  return (
    <>
      <style suppressHydrationWarning>{`
        ...
        .btn-primary:hover { background:#b91c1c; box-shadow: 0 8px 28px rgba(220,38,38,0.45); transform: translateY(-1px); }
        .btn-secondary:hover { background: rgba(220,38,38,0.06); border-color: rgba(220,38,38,0.35) !important; color: #ef4444 !important; transform: translateY(-1px); }
        ...
        .scroll-indicator { position:absolute; bottom:32px; left:50%; transform:translateX(-50%); display:flex; flex-direction:column; align-items:center; gap:6px; animation:fadeIn 1s ease both; animation-delay:1.8s; opacity:0; z-index:10; }
      ...
      <section id="home" className="hero-section" style={{ background: t.heroBg }}>
        ...
        <div className="hero-inner">
          ...
          <div className="hero-left">
            ...
            <div className="btn-row">
              {/* ✅ FIXED: "Get In Touch" — clear and recruiter-friendly */}
              ...
              {/* ✅ FIXED: "Download CV" — professional */}
              <button
        ...
        <div className="scroll-indicator">
          <span style={{ fontSize: '0.58rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: t.scrollColor }}>Scroll</span>
          <div style={{
