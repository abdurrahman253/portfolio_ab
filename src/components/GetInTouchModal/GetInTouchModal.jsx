...
export default function GetInTouchModal({ isOpen, onClose }) {
  ...
  const t = {
    ...
    cardBg:       isDark ? 'rgba(10,10,14,0.97)'           : 'rgba(255,255,255,0.98)',
    cardBorder:   isDark ? 'rgba(220,38,38,0.2)'           : 'rgba(220,38,38,0.18)',
    cardShadow:   isDark
      ? '0 0 80px rgba(185,28,28,0.22), 0 32px 64px rgba(0,0,0,0.75), inset 0 1px 0 rgba(255,255,255,0.04)'
      : '0 0 60px rgba(220,38,38,0.1), 0 24px 48px rgba(0,0,0,0.15)',
    heading:      isDark ? '#f8fafc'                       : '#0f172a',
    subtext:      isDark ? '#64748b'                       : '#64748b',
    divider:      isDark ? 'rgba(220,38,38,0.1)'           : 'rgba(220,38,38,0.1)',

    // Close button
    closeBg:      isDark ? 'rgba(220,38,38,0.08)'          : 'rgba(220,38,38,0.06)',
    closeBorder:  isDark ? 'rgba(220,38,38,0.25)'          : 'rgba(220,38,38,0.2)',
    closeColor:   isDark ? '#94a3b8'                       : '#64748b',

    // Action cards
    cardItemBg:   isDark ? 'rgba(220,38,38,0.07)'          : 'rgba(220,38,38,0.05)',
    cardItemBorder: isDark ? 'rgba(220,38,38,0.18)'        : 'rgba(220,38,38,0.15)',
    cardItemTitle: isDark ? '#f1f5f9'                      : '#0f172a',

    // Copy row
    copyBg:       isDark ? 'rgba(255,255,255,0.03)'        : 'rgba(0,0,0,0.03)',
    copyBorder:   isDark ? 'rgba(255,255,255,0.07)'        : 'rgba(0,0,0,0.08)',
    copyEmail:    isDark ? '#64748b'                       : '#475569',
    copyHoverBg:  isDark ? 'rgba(255,255,255,0.06)'        : 'rgba(0,0,0,0.06)',
    copyHoverBorder: isDark ? 'rgba(220,38,38,0.2)'        : 'rgba(220,38,38,0.2)',

    // Socials
    socialBg:     isDark ? 'rgba(255,255,255,0.03)'        : 'rgba(0,0,0,0.04)',
    socialBorder: isDark ? 'rgba(255,255,255,0.07)'        : 'rgba(0,0,0,0.1)',
    socialColor:  isDark ? '#475569'                       : '#64748b',
    findMe:       isDark ? '#334155'                       : '#94a3b8',

    // Badge
    badgeBg:      isDark ? 'rgba(220,38,38,0.07)'          : 'rgba(220,38,38,0.06)',
  ...
  return (
    <>
      <style suppressHydrationWarning>{`
        ...
        /* ✅ CURSOR FIX: modal overlay must NOT hide cursor elements (z-index 99999+) */
        .modal-overlay * { cursor: auto; }
        .modal-overlay button, .modal-overlay a { cursor: pointer; }
      `}</style>

      {/* ✅ z-index: 9998 so Cursor component (z-index 9999+) stays on top */}
      <div
        ref={overlayRef}
        ...
        style={{
          ...
          zIndex: 9998,           /* ← cursor sits at 9999, stays visible */
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          padding: 16,
      ...
      >
        ...
        <div style={{
          ...
          <button
            ...
            onMouseLeave={e => Object.assign(e.currentTarget.style, { background: t.closeBg, color: t.closeColor, borderColor: t.closeBorder })}
          >
            ✕
          </button>
          ...
          <div style={{ padding: '28px 28px 8px' }}>
            ...
            <h2 style={{ fontSize: '2rem', fontWeight: 900, color: t.heading, margin: 0, letterSpacing: '-0.03em', lineHeight: 1.1, transition: 'color 0.3s ease' }}>
              Let's build<br />
              <span style={{ color: '#dc2626' }}>something great.</span>
            </h2>
            <p style={{ margin: '10px 0 0', fontSize: '0.88rem', color: t.subtext, lineHeight: 1.6 }}>
              Open to new projects, freelance work, and full-time opportunities.
            </p>
          </div>

          {/* Divider */}
          <div style={{ margin: '20px 28px', height: 1, background: t.divider }} />
          ...
          <div style={{ padding: '0 28px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <a
              ...
              onMouseLeave={e => Object.assign(e.currentTarget.style, { background: t.cardItemBg, borderColor: t.cardItemBorder, transform: 'none' })}
            >
              ...
              <div>
                <p style={{ fontSize: '0.85rem', fontWeight: 700, color: t.cardItemTitle, margin: 0, transition: 'color 0.3s' }}>Book a call</p>
            ...
            >
              ...
              <div>
                <p style={{ fontSize: '0.85rem', fontWeight: 700, color: t.cardItemTitle, margin: 0, transition: 'color 0.3s' }}>Email me</p>
          ...
          <div style={{ padding: '14px 28px 0' }}>
            <button
              ...
              onMouseEnter={e => Object.assign(e.currentTarget.style, { background: t.copyHoverBg, borderColor: t.copyHoverBorder })}
              onMouseLeave={e => Object.assign(e.currentTarget.style, { background: t.copyBg, borderColor: t.copyBorder })}
            >
              <span style={{ fontSize: '0.82rem', color: t.copyEmail, fontFamily: 'monospace' }}>{GMAIL}</span>
          ...
          <div style={{ padding: '16px 28px 26px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontSize: '0.75rem', color: t.findMe, letterSpacing: '0.05em' }}>Find me on</span>
            <div style={{ display: 'flex', gap: 8 }}>
              {[
                ...
                <a
                  ...
                  onMouseLeave={e => Object.assign(e.currentTarget.style, { borderColor: t.socialBorder, color: t.socialColor, background: t.socialBg })}
                >
                  <Icon />
                </a>
              ))}
