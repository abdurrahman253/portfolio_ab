...
// ── Stat boxes shown in journey card ─────────────────────────────────────────
const journeyStats = [
  { label: 'Started Coding',  value: '2025' },
  { label: 'Projects Built',  value: '10+'  },
  { label: 'Tech Learned',    value: '46+'  },
  { label: 'Mindset',         value: '🔥'   },
];
...
function EduCard({ edu, isDark, index }) {
  ...
  return (
    <div className="edu-card-container" style={{
      display: 'flex',
      ...
      <motion.div
        ...
        style={{
          ...
          width: 42, height: 42,
          borderRadius: '50%',
          background: isDark ? 'rgba(10,10,14,1)' : '#f8fafc',
      ...
      >
        ...
        <div className="edu-connector" style={{
          ...
          [isLeft ? 'borderLeft' : 'borderRight']: `10px solid ${t.cardBorder}`,
        }} />

        {/* Year badge */}
        <div style={{
          display: 'inline-flex', alignItems: 'center', gap: 6,
          marginBottom: 14, padding: '4px 11px',
          borderRadius: 999,
          background: isDark ? 'rgba(220,38,38,0.1)' : 'rgba(220,38,38,0.07)',
          border: '1px solid rgba(220,38,38,0.2)',
        }}>
          <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#ef4444', display: 'inline-block' }} />
          <span style={{ fontSize: '0.68rem', fontWeight: 700, color: '#ef4444', letterSpacing: '0.1em' }}>
            {edu.year}
          </span>
          <span style={{ fontSize: '0.65rem', color: isDark ? '#475569' : '#94a3b8', fontWeight: 500 }}>
            · {edu.duration}
          </span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 16 }}>
          ...
          <span style={{ fontSize: '0.8rem', color: t.sub, fontWeight: 500 }}>
        ...
        {/* Description */}
        <p style={{ margin: '0 0 18px', fontSize: '0.88rem', lineHeight: 1.8, color: t.body }}>
          {edu.description}
        </p>

        {/* Journey stats (only for selftaught card) */}
        {edu.id === 'selftaught' && (
          <div style={{
            ...
            {journeyStats.map((s) => (
              <div key={s.label} style={{
                ...
                borderRadius: 10,
                background: isDark ? 'rgba(220,38,38,0.07)' : 'rgba(220,38,38,0.05)',
                border: '1px solid rgba(220,38,38,0.14)',
              }}>
                <p style={{ margin: 0, fontSize: '1rem', fontWeight: 900, color: '#ef4444', letterSpacing: '-0.02em' }}>
                  {s.value}
                </p>
                <p style={{ margin: '3px 0 0', fontSize: '0.6rem', fontWeight: 600, color: t.sub, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                  {s.label}
                </p>
              </div>
            ))}
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        .edu-title-accent {
          ...
          animation: shimmer-edu 3s linear infinite;
        }
      ...
      >
        ...
        <div style={{
          ...
          animation:'edu-pulse 8s ease-in-out infinite',
        }} />
        <div style={{
          ...
          animation:'edu-pulse 10s ease-in-out infinite', animationDelay:'4s',
        }} />
        ...
        <div className="edu-main-container" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 48px', position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            <h2 style={{
              ...
              lineHeight: 1.1, margin: '0 0 14px', color: t.heading,
            }}>
              Education &{' '}
              <span className="edu-title-accent">Learning Path</span>
            </h2>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div
              ...
              style={{
                ...
                width: 1,
                background: `linear-gradient(180deg, transparent, ${t.timelineLine} 15%, ${t.timelineLine} 85%, transparent)`,
                transform: 'translateX(-50%)',
                zIndex: 0,
              }}
            />
          ...
          >
            ...
            <div style={{
              fontSize: '4rem', lineHeight: 1, color: 'rgba(220,38,38,0.12)',
